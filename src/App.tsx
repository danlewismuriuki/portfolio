  ...
  const projects = [
    {
      ...
      description:
        "Founded and developed a second-hand book marketplace platform that revolutionized educational accessibility in Kenya, implementing secure payment systems and optimized user experience",
      image:
    ...
    },
    {
      ...
      description:
        "Engineered scalable backend infrastructure for agricultural data processing, enabling global stakeholder collaboration and data-driven decision making",
      image:
    ...
    },
    {
      ...
      description:
        "Led development of microservices-based supply chain platform at Witz Africa, improving food security and vendor-supplier connections",
      image:
  ...
  const achievements = [
    {
      metric: "50TB+",
      description:
        "Agricultural data processed and made accessible through GODAN platform",
      icon: <Database className="text-emerald-600" size={32} />,
    },
    {
      metric: "99.9%",
      description:
        "System uptime achieved across distributed microservices architecture",
      ...
      <section className="container mx-auto px-6 py-24 relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <h1 className="text-6xl font-bold text-gray-900 mb-6">
            Full Stack Engineer
            <span className="block text-4xl mt-2 text-emerald-600">
              Backend Expert • Cloud Architecture • Web3
            </span>
          </h1>
          <p className="text-xl text-gray-700 mb-8 leading-relaxed max-w-3xl">
            Specialized in building scalable backend systems and distributed
            architectures. Experienced in cloud platforms, microservices, and
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Developed backend systems supporting open data initiatives
                ...
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 mt-2 rounded-full bg-emerald-600" />
                  <p>
                    Designed APIs facilitating data sharing among global
                    stakeholders
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 mt-2 rounded-full bg-emerald-600" />
                  <p>
                    Led capacity-building efforts to improve data-driven
                    decision-making
                  </p>
                </li>
              </ul>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Led backend team in building scalable supply chain logistics
                    solutions
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 mt-2 rounded-full bg-blue-600" />
                  <p>
                    Designed microservices architecture for vendor-supplier
                    connections
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 mt-2 rounded-full bg-blue-600" />
                  <p>
                    Implemented mobile-based ordering systems for enhanced
                    accessibility
                  </p>
                </li>
              </ul>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Developed RESTful APIs and optimized database queries for
                    performance
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 mt-2 rounded-full bg-purple-600" />
                  <p>
                    Implemented security best practices for authentication and
                    data encryption
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 mt-2 rounded-full bg-purple-600" />
                  <p>
                    Participated in Agile sprints and iterative development
                    cycles
                  </p>
                </li>
              </ul>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Built a second-hand book marketplace to make education more
                    affordable in Kenya
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 mt-2 rounded-full bg-yellow-600" />
                  <p>
                    Created platform for parents to sell & buy school books at
                    lower costs
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 mt-2 rounded-full bg-yellow-600" />
                  <p>
                    Integrated secure payment gateways and seamless user
                    experience
                  </p>
                </li>
              </ul>
              ...
              >
                ...
                <div className="flex flex-wrap gap-3">
                  {category.items.map((skill, i) => (
                    <span
                      key={i}
                      className="px-4 py-2 bg-white rounded-lg text-gray-700 shadow-sm"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2">
                    Expert in AWS core services including Lambda, API Gateway,
                    and EC2
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2">
                    Advanced data processing, visualization, and analytical
                    modeling
                  </p>
                </div>
              </div>
      ...
      <footer className="py-12 bg-white">
        <div className="container mx-auto px-6 text-center">
          <p className="text-gray-600">
            © {new Date().getFullYear()} • Full Stack Engineer & System
            Architect
          </p>
        </div>
      </footer>
